...
class MainApplication : Application(), ReactApplication {
  ...
  override fun onCreate() {
    ...
    registerActivityLifecycleCallbacks(lifecycleCallbacks)  registerActivityLifecycleCallbacks(lifecycleCallbacks)  registerActivityLifecycleCallbacks(lifecycleCallbacks)}
